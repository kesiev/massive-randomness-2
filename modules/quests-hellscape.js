                                                ...
                                                explanation:[
                                                    {
                                                        ...
                                                        EN:"When you open the door with the red outline on the {tileLabel.center} tile, do not resolve Door cards, remove the Corruption token {symbol.corruptionToken}, and generate a Level 5 Roaming Monster in its area.<p>Draw cards from the Level 5 Horde Items deck until you reveal a weapon with the same attack type as the Roaming Monster. Equip that weapon to the Wandering Monster, adding the weapon's dice to the Roaming Monster's Attack dice pool.</p>"
                                                    }
                                                ]
                                            }
                                        ]
